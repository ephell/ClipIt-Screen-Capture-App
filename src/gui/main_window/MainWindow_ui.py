...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.separator_line.setMinimumSize(QSize(0, 0))
        self.separator_line.setMaximumSize(QSize(16777215, 16777215))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.record_button.setToolTip(QCoreApplication.translate("MainWindow", u"Start/Stop Recording", None))
#endif // QT_CONFIG(tooltip)
        self.record_button.setText("")
#if QT_CONFIG(tooltip)
        self.screenshot_button.setToolTip(QCoreApplication.translate("MainWindow", u"Take A Screenshot", None))
#endif // QT_CONFIG(tooltip)
        self.screenshot_button.setText("")
#if QT_CONFIG(tooltip)
        self.open_editor_button.setToolTip(QCoreApplication.translate("MainWindow", u"Open Editor", None))
#endif // QT_CONFIG(tooltip)
        self.open_editor_button.setText("")
#if QT_CONFIG(tooltip)
        self.open_capture_folder_button.setToolTip(QCoreApplication.translate("MainWindow", u"Open Captures Directory", None))
#endif // QT_CONFIG(tooltip)
        self.open_capture_folder_button.setText("")
#if QT_CONFIG(tooltip)
        self.settings_button.setToolTip(QCoreApplication.translate("MainWindow", u"Open Settings", None))
#endif // QT_CONFIG(tooltip)
